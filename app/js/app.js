...
(function ($) {
  ...
  var mobileNav = function () {
    ...
    $(document).on("click", ".mobile-button", function () {
      ...
      $("#main-nav-mobi").slideToggle().toggleClass("active");
  ...
  var tooglesidebar = function () {
    $('.toogle-sidebar-button').on('click',function(){
      $('.toogle-sidebar-content').toggleClass('active');
    });
    $('.toogle-sidebar-close').on('click',function(event){
      $('.toogle-sidebar-content').toggleClass('active');
